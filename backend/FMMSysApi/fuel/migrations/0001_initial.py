# Generated by Django 2.1.5 on 2019-01-09 10:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('delievery_order', models.AutoField(help_text='The ordered number or bond de command of the purchase that has been made to be delivered.', primary_key=True, serialize=False, unique=True, verbose_name='Order number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('transaction_no', models.AutoField(default=0, help_text="The threshold quantity that can't be consumed.", primary_key=True, serialize=False, verbose_name='Transaction number')),
                ...
                ('eta', models.DateField(default=datetime.datetime.today, help_text='The Estimated Time of Arrival of the order that is being made.', verbose_name='Estimated Arrival Date')),
                ('order_qty', models.FloatField(default=0, help_text='The quantity of fuel ordered.', verbose_name='Quantity Ordered')),
                ('delivery_order', models.ForeignKey(help_text='The delivery order linked to this schedule.', on_delete=django.db.models.deletion.CASCADE, to='fuel.DeliveryOrder', verbose_name='Delivery Order No.')),
            ],
            options={
